...
const SignUp = () => {
  // const [avatar, setavatar] = useState("https://i.waifu.pics/pojy7zt.jpg");
  ...
  const handleSubmitt = async (e) => {
    e.preventDefault(); //to not rfereghs page
    await signup(Inputs);
    console.log(Inputs);
  };
        ...
        <form>
          <div className="flex flex-col items-center px-2">
            <div className="avatar flex items-center    ">
              ...
              <button
                className="btn btn-ghost ml-7 text-white"
                onClick={changeanime}
                disabled={Loadingg}
              >
                {!Loadingg && ImageLoad ? (
